...
if FLASK_PREFIX != '/homol':
    ...
    def queryes():
        ...
        response_data = {
            "timestamp": timestamp,
            "data": {
                "multas_mensagens_erro_nao_tratadas": safe_get("id2"),
                "multas_mensagens_erro_tratadas": safe_get("id3"),
                "renainf_percentual_da_meta": safe_get("id4"),
                "renainf_d_percentual_da_meta": safe_get("id5"),
                "serpro_dia_semmulta_percentual_cpf": safe_get("id6"),
                "serpro_dia_semmulta_percentual_cnpj": safe_get("id7"),
                "multaANTT_last5day": safe_get("id8")
            }
        }
